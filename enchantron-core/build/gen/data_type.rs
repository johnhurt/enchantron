...
impl DataType {
  ...
  pub fn rust_generic(symbol: &'static str, bound_type: DataType) -> DataType {
  ...
  pub fn swift_generic(symbol: &'static str, bound_type: DataType) -> DataType {
