...
pub struct RenderableDataType {
    ...
    pub rust_type_coercion_prefix_incoming: String,
    pub rust_type_coercion_postfix_incoming: String,
    pub rust_type_coercion_prefix_outgoing: String,
    pub rust_type_coercion_postfix_outgoing: String,

    pub swift_name_internal: String,
    pub swift_name_incoming: String,
    pub swift_name_outgoing: String,

    pub swift_type_coercion_prefix_incoming: String,
    pub swift_type_coercion_postfix_incoming: String,
    pub swift_type_coercion_prefix_outgoing: String,
    pub swift_type_coercion_postfix_outgoing: String,
}
    ...
    pub fn from_raw(data_type: &DataType) -> RenderableDataType {
        ...
        match data_type {
            ...
            DataType::Any => builder
                ...
                .rust_type_coercion_prefix_incoming("unsafe { &*".to_owned())
                .rust_type_coercion_postfix_incoming(" }".to_owned())
                .rust_type_coercion_prefix_outgoing(
                    "Box::into_raw(Box::new(".to_owned(),
                )
                .rust_type_coercion_postfix_outgoing("))".to_owned())
                .swift_name_internal("RustAny".to_owned())
                .swift_name_incoming("OpaquePointer?".to_owned())
                .swift_name_outgoing("OpaquePointer?".to_owned())
                .swift_type_coercion_prefix_incoming("BoxedAny(".to_owned())
                .swift_type_coercion_postfix_incoming(")".to_owned())
                .swift_type_coercion_prefix_outgoing("".to_owned())
                .swift_type_coercion_postfix_outgoing(".ref".to_owned()),
            ...
            DataType::Future(struct_type) => builder
                ...
                .rust_name_incoming("*mut Future".to_owned())
...
fn render_rust_struct_type(
    ...
    builder
        ...
        .swift_name_incoming("OpaquePointer?".to_owned())
        .swift_name_outgoing("OpaquePointer?".to_owned())
        .swift_type_coercion_prefix_incoming(struct_type.name.to_owned() + &"(")
        .swift_type_coercion_postfix_incoming(")".to_owned())
        .swift_type_coercion_prefix_outgoing("".to_owned())
        .swift_type_coercion_postfix_outgoing(".ref".to_owned())
}
...
fn render_swift_struct_type(
    ...
    builder
        ...
        .rust_type_coercion_prefix_incoming(struct_type.name.to_owned() + &"(")
        .rust_type_coercion_postfix_incoming(")".to_owned())
        .rust_type_coercion_prefix_outgoing("".to_owned())
        .rust_type_coercion_postfix_outgoing(".0".to_owned())
        .swift_name_internal(struct_type.name.to_owned())
        .swift_name_incoming("OpaquePointer?".to_owned())
        .swift_name_outgoing("OpaquePointer?".to_owned())
        .swift_type_coercion_prefix_incoming(
        ...
        .swift_type_coercion_postfix_incoming(
            "!)).takeUnretainedValue()".to_owned(),
        )
        .swift_type_coercion_prefix_outgoing(
            "OpaquePointer(Unmanaged.passRetained(".to_owned(),
        )
        .swift_type_coercion_postfix_outgoing(").toOpaque())".to_owned())
}
...
fn render_byte_buffer_type(
    ...
    match bb_type {
        ByteBufferType::Stringy => builder
            ...
            .rust_type_coercion_prefix_incoming("SwiftString(".to_owned())
            .rust_type_coercion_postfix_incoming(").to_string()".to_owned())
            .rust_type_coercion_prefix_outgoing(
        ...
        ByteBufferType::TextureData => builder
            ...
            .rust_name_outgoing("*mut ByteBuffer".to_owned())
            .rust_type_coercion_prefix_incoming(
                "panic!(\"Cannot receive ".to_owned(),
            )
            .rust_type_coercion_postfix_incoming(" from swift\")".to_owned())
            .rust_type_coercion_prefix_outgoing(
                "Box::into_raw(Box::new(".to_owned(),
            )
            .rust_type_coercion_postfix_outgoing("))".to_owned())
