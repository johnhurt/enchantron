...
use ui::{HasMutableVisibility, Sprite, SpriteSource};
    ...
    S: Sprite<T = T>,
{
    ...
    pub fn set_rect_animated(&self, rect: &Rect, duration_seconds: f64) {
        ...
        self.card_sprite
            .set_size_animated(width, height, duration_seconds);
        self.card_sprite
            .set_location_animated(left, top, duration_seconds);
...
impl<S> HasMutableVisibility for UiCard<S>
where
    S: Sprite,
{
